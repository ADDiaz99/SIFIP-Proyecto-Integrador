package gui;
//package Sistema Finanzas;
import javax.swing.*;
import java.awt.*;
import java.awt.event.*;
import java.text.*;
public class CalculadoraPrestamos extends JFrame
{
...
{
// create frame
new CalculadoraPrestamos().show();
}
public CalculadoraPrestamos()
{
// frame constructor
setTitle("Calculadora de Prestamos");
setResizable(false);
...
balanceLabel.setText("Balance del Prestamo");
...
interestLabel.setText("Porcentaje de Interes");
...
monthsLabel.setText("Numero de Cuotas");
...
paymentLabel.setText("Pago Mensual");
...
newLoanButton.setText("Nuevo Analisis de Prestamo");
...
analysisLabel.setText("Descripcion de Prestamo:");
...
analysisTextArea.setFocusable(true);
...
//Float interes_f = Float.parseFloat(interes);
//if(interes_f > 6){
//    analysisTextArea.setText("Ten cuidado, el interes parece ser demasiado alto para este prestamo, no es recomendable.");
//}
...
{
	JOptionPane.showConfirmDialog(null, "Balance Invalido o Negativo.\nPor favor Corregir.", "Error Input Balance", JOptionPane.DEFAULT_OPTION,
...
{
JOptionPane.showConfirmDialog(null, "Interes Invalido o Negativo.\nPor favor Corregir.", "Interes Input Error", JOptionPane.DEFAULT_OPTION,
JOptionPane.INFORMATION_MESSAGE);
return;
}
...
{
JOptionPane.showConfirmDialog(null, "Cantidad de Cuotas Invalido o Negativo.\nPor favor Corregir.", "Cantidad de Cuotas Input Error",
...
{
if (JOptionPane.showConfirmDialog(null, "Pago minimo debe ser $" +
new DecimalFormat("0.00").format((int)(balance * monthlyInterest + 1.0)) + "\n" + "Quieres usar el pago minimo?", "Input Error", JOptionPane.YES_NO_OPTION,
...
{
JOptionPane.showConfirmDialog(null, "Pago Mensual Invalido.\nCorregir.", "Payment Input Error", JOptionPane.DEFAULT_OPTION,
JOptionPane.INFORMATION_MESSAGE);
return;
}
if (interest == 0)
...
Double.valueOf(paymentTextField.getText()).doubleValue();
// show analysis
analysisTextArea.setText("Balance Prestamo: $" + new
DecimalFormat("0.00").format(balance));
analysisTextArea.append("\n" + "Porcentaje de Interes: " + new
...
Float interes_f = Float.parseFloat(interes);
if(interes_f > 6){
    analysisTextArea.append("Ten cuidado, el interes parece ser demasiado alto para este prestamo, no es recomendable.");
}
...
computeButton.setText("Calcular Cantidad de Cuotas");
balanceTextField.requestFocus();
}
